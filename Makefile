...
SRC = webserv.cpp code/handlingConfig.cpp code/handlingRequest.cpp code/tools.cpp class/Response.cpp class/Request.cpp code/GetMehod/handlingGet.cpp class/Autoindex.cpp
